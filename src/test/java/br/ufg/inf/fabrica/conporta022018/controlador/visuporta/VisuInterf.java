...
import br.ufg.inf.fabrica.conporta022018.controlador.ControladorVisuInterf;
...
public class VisuInterf {

    private static ControladorVisuInterf controladorVisuInterf;
    ...
    public static void casoTestPepararCenario() throws IOException, ParseException {
        ...
        String CAMINHO_CSV = "src/test/java/br/ufg/inf/fabrica/conporta022018/controlador/visuporta/VisuInterfTest.csv";
        String REGRA = ";";
    ...
    public void casoTestPrepararExecucao() {
        ...
        controladorVisuInterf = new ControladorVisuInterf();
    ...
    public void casoTestDadoValido() throws IOException, Exception {
       ...
       PessoaDAO pessoaDAO = new PessoaDAO();
        ...
        ControladorConAcess controladorConAcess = new ControladorConAcess();
        Pessoa pessoa = controladorConAcess.buscarPorCPF("241dreetrthytte4h.124-51");
