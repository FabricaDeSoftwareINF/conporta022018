...
public class ControladorConAcessTest extends Mockito {
    ...
    public void casoTestControladorConAcess() throws IOException, ParseException {
        ...
        /*             -------->>> 2ª Parte - Testes do Framework  <<<---------                   */


        /*
         * Esta parte exercita o Framework.
         *
         * Por limitação os teste apresentados abaixo são mocki, pois não possui um servelet
         * para fazer chamadas, assim não ah ninguém escultando as chamadas que seria realizada
         * pelos teste, sendo impossível testa. Porém como o Framework consomem os dados do
         * controlador testado acima assume-se como verdade os testes abaixo.
         */
